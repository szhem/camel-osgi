...
public class OsgiMulticastEndpointConsumerErrorHandlingTest extends OsgiIntegrationTest {
    ...
    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.itest.OsgiMulticastEndpointConsumerErrorHandlingTest.producer)")
    private CamelContext producerContext;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.itest.OsgiMulticastEndpointConsumerErrorHandlingTest.consumer1)")
    private CamelContext consumer1Context;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.itest.OsgiMulticastEndpointConsumerErrorHandlingTest.consumer2)")
    ...
    public void testHandleException() throws Exception {
        ...
        reply.allMessages().simple("${body.getException()} != null || ${body.getIn().getBody()} == '1234567890-2'",
            Boolean.class);
