...
public class OsgiMulticastSimpleProcessorTest extends OsgiIntegrationTest {
    ...
    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.itest.OsgiMulticastSimpleProcessorTest.producer)")
    private CamelContext producerContext;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.itest.OsgiMulticastSimpleProcessorTest.consumer1)")
