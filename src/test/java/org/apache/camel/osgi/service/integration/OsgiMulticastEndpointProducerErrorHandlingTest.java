...
public class OsgiMulticastEndpointProducerErrorHandlingTest extends OsgiIntegrationTest {
    ...
    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiMulticastEndpointProducerErrorHandlingTest.producer)")
    private CamelContext producerContext;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiMulticastEndpointProducerErrorHandlingTest.consumer1)")
    private CamelContext consumer1Context;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiMulticastEndpointProducerErrorHandlingTest.consumer2)")
