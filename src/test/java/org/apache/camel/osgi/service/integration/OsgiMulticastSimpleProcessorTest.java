...
public class OsgiMulticastSimpleProcessorTest extends OsgiIntegrationTest {

    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiMulticastSimpleProcessorTest.producer)")
    private CamelContext producerContext;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiMulticastSimpleProcessorTest.consumer1)")
        ...
        return new Option[] {
            ...
            provision(
                bundle()
                    ...
                    .build(),
                bundle()
                    .add("OSGI-INF/blueprint/blueprint-context.xml",
                    ...
                    .set(Constants.BUNDLE_VERSION, "1.0.0")
                    .add(OsgiMulticastSimpleProcessorTestProcessor.class)
                    .set(Constants.IMPORT_PACKAGE, Processor.class.getPackage().getName())
                    .removeHeader(Constants.EXPORT_PACKAGE)
                    .build(),
                bundle()
                    .add("OSGI-INF/blueprint/camel-context.xml",
    ...
    public void testSendMessage() throws Exception {
        ...
        producer.expectedBodiesReceivedInAnyOrder("1234567890-1", "1234567890-reply");
