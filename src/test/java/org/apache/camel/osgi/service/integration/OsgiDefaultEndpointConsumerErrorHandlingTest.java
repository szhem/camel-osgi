...
import org.apache.camel.osgi.service.integration.OsgiIntegrationTest;
...
public class OsgiDefaultEndpointConsumerErrorHandlingTest extends OsgiIntegrationTest {
    ...
    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiDefaultEndpointConsumerErrorHandlingTest.producer)")
    private CamelContext producerContext;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiDefaultEndpointConsumerErrorHandlingTest.consumer)")
