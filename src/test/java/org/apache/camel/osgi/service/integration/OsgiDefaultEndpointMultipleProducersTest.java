...
public class OsgiDefaultEndpointMultipleProducersTest extends OsgiIntegrationTest {
    ...
    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiDefaultEndpointMultipleProducersTest.producer1)")
    private CamelContext producer1Context;

    @Inject
    @Filter(value = "(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiDefaultEndpointMultipleProducersTest.producer2)")
    private CamelContext producer2Context;

    @Inject
    @Filter("(camel.context.symbolicname=org.apache.camel.osgi.service.integration.OsgiDefaultEndpointMultipleProducersTest.consumer)")
