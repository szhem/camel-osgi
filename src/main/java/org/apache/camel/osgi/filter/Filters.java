...
public final class Filters {
     ...
     * @param attr the name of attribute
     * @param val the value to check the attribute against
     * @param mode the {@link org.apache.camel.osgi.filter.LikeCriterion.MatchMode} to be used
     *
    ...
    /**
     * Creates the criterion that represents that uses {@link org.apache.camel.osgi.filter.LikeCriterion.MatchMode#EXACT}
     * to match the specified attribute to the specified value.
     *
     * @param attr the name of attribute
     * @param val the value to check the attribute against
     *
     * @return the criterion that represents that uses {@link org.apache.camel.osgi.filter.LikeCriterion.MatchMode#EXACT}
     * to match the specified attribute to the specified value
     */
